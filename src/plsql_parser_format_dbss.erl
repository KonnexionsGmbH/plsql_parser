...
fold(LOpts, _FunState, Ctx, #{apiGroupAnnotation := PTree},
    {apiGroupAnnotation, Step} = _FoldState) ->
...
fold(LOpts, _FunState, Ctx, #{apiHiddenAnnotation := PTree},
...
fold(LOpts, _FunState, Ctx, #{packageItemConditional := PTree},
    ...
    PackageItem = maps:get(packageItem, PackageItem@),
             ...
             start ->
                 ...
                 lists:append(
                     [
                         ...
                         case maps:is_key(man_page@, PackageItem) of
                             true -> lists:append(
                                 [
                                     ?TABULATOR,
                                     ?TABULATOR,
                                     ?TABULATOR,
                                     "<ManPage>",
                                     string:replace(string:replace(string:replace(maps:get(man_page@, PackageItem), "<", "&lt", all), ">", "&gt", all), "&",
                                         "&amp", all),
                                     ?CHAR_NEWLINE,
                                     ?TABULATOR,
                                     ?TABULATOR,
                     ...
                     case maps:is_key(man_page@, PTree) of
                         true -> lists:append(
                             [
                                 ?TABULATOR,
                                 "<ManPage>",
                                 string:replace(string:replace(string:replace(maps:get(man_page@, PTree), "<", "&lt", all), ">", "&gt", all), "&", "&amp", all),
                                 ?CHAR_NEWLINE,
                                 ?TABULATOR,
                                 "</ManPage>",
                                 ?CHAR_NEWLINE
