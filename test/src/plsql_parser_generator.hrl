...
-define(ALL_CLAUSE_PERFORMANCE, [createPackage]).
-define(ALL_CLAUSE_RELIABILITY, [createPackage]).
-define(ALL_CLAUSE_RELIABILITY_SQL, [createPackage]).
-define(
...
-define(
  ...
  ?D("~n code size          ===  ~12.. B rule: ~s ~n", [length(Code), atom_to_list(Rule)]),
  ?D(
